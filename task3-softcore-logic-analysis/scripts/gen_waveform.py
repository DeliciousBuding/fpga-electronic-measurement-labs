...
fig.text(0.98, 0.005, 'Source: ModelSim SE 2020.4  |  DUT: task3_dcfifo_ip (16-bit x 16 deep)  |  tc: 1 ps',
         fontsize=6, fontfamily='monospace', ha='right', color='gray')

plt.tight_layout(rect=[0.08, 0.03, 1, 0.96])
fig.savefig('D:/Code/Quartus/task3-softcore-logic-analysis/figures/task3_modelsim_waveform.png',
