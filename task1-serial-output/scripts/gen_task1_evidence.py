...
plt.tight_layout()
fig.savefig('D:/Code/Quartus/task1-serial-output/task1-1-ws2812/figures/task1_ws2812_timing.png',
...
plt.tight_layout()
fig.savefig('D:/Code/Quartus/task1-serial-output/task1-4-uart-tx/figures/task1_uart_tx_timing.png',
            dpi=180, bbox_inches='tight', facecolor='white', edgecolor='none')
